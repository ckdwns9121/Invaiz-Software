...
namespace Invaiz_Console.Component
{
    public partial class FunctionCategory : UserControl
    {
        ...
        private Image openImage = Invaiz_Console.Properties.Resources.folder2;
        private Image closeImage = Invaiz_Console.Properties.Resources.folder;


        private void category_name_Click(object sender, EventArgs e)
        {
            if (!toggle)
            {
