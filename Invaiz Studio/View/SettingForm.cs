    ...
    public partial class SettingForm : Form
    {
        ...
        private void functionOn(object sender, MouseEventArgs e)
        {
            if (e.Button == MouseButtons.Left)
            {
                ...
                this.function_on.Image = Invaiz_Studio.Properties.Resources.selection;
                this.key_on.Image = Invaiz_Studio.Properties.Resources.selection_off;
                this.function_panel.Visible = true;
        ...
        private void keypressOn(object sender, MouseEventArgs e)
        {
            ...
            {
                this.customScrollbar1.Visible = false;
                this.function_on.Image = Invaiz_Studio.Properties.Resources.selection_off;
                this.key_on.Image = Invaiz_Studio.Properties.Resources.selection;
            ...
            if (e.Control) //컨트롤
            {
                if (e.Shift)
                {
                    if (e.Alt) //컨트롤 + 쉬프트 + 알트  + A
                    {
                        ...
                        shift = "Shift + ";
                        alt = "Alt+ ";
                        this.changeKeycode1 = k.setKeycode(ctrl, shift, alt, subName1_input, e);
                        this.changeMulti1 = 7;
                    }
                    else //컨트롤 + 쉬프트 + A
                    {
